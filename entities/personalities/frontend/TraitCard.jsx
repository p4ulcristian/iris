...
import { faPenToSquare, faTrash, faPuzzlePiece, faLock } from '@fortawesome/free-solid-svg-icons'

export default function TraitCard({ trait, onEdit, onDelete, staggerIndex = 0 }) {
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {isBundled && (
              <span
                ...
                title="Bundled traits are read-only"
              >
        ...
        {/* Preview */}
        {preview && (
          <div className="text-[10px] text-white/40 line-clamp-1 font-mono mt-1 leading-relaxed">
            {preview}
          </div>
        )}
      </div>
