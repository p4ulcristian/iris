    ...
    <div className="group p-4 bg-black/30 border border-white/10 rounded-xl hover:bg-black/40 hover:border-white/20 transition-all">
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          className="opacity-0 group-hover:opacity-100 px-3 py-1.5 text-xs font-medium rounded-lg bg-accent/20 text-accent border border-accent/30 hover:bg-accent/30 transition-all"
        >
          Resume ▸
        </button>
      </div>
